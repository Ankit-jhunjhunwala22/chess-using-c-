...
int whitequeen::givemetheplayer()
{
return 202;
}
void whitequeen::findpossiblelocationtomoveorattack()
{
int i,j;
i=j=0;
int curx;
...
while(cury <=7 )
{
    if(chessboard[curx][cury]==NULL)
    {
        possiblemove[i].x=curx;
        possiblemove[i++].y=cury;
        eastcountertomove=eastcountertomove+1;
        cury=cury+1;
        if(cury >7)break;
    }
    else if(chessboard[curx][cury]!=NULL && chessboard[curx][cury]->givetypeofplayer()==0)
...
if(noofmovepos)
    {
        ...
        int j=0;
        int tem;
        cout<<"possible location to move from the whitequeen\n";
    ...
    cout<<"No location to move from the whitequeen at ("<<posx<<","<<posy<<")\n";
if(noofattackpos)
    {
   ...
   cout<<"\nNo location to attack from the whitequeen at ("<<posx<<","<<posy<<")\n";
}
void whitequeen::move(){
if(noofmovepos)
    {
    int usrx;
    int usry;
    cout<<"\nenter positions to move from the whitequeen\n";
    while(2){
                cin>>usrx;
                cin>>usry;
...
void whitequeen::attack(){
    if(noofattackpos)
        {
            int usrx;
            int usry;
            cout<<"\nenter positions to attack from the whitequeen\n";
    while(2){
                cin>>usrx;
                cin>>usry;
        ...
        {
            cout<<"no positions to attack from the whitequeen\n";
        }
