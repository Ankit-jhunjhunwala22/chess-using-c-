...
int blackuut::givemetheplayer()
{
return 104;
}
void blackuut::findpossiblelocationtomoveorattack()
{
int i,j;
i=j=0;
int curx;
...
if(noofmovepos)
    {
        ...
        int j=0;
        int tem;
        cout<<"possible location to move from the blackuut at("<<posx<<","<<posy<<")\n";
    ...
    cout<<"No location to move from the blackuut at ("<<posx<<","<<posy<<")\n";
if(noofattackpos)
    {
   ...
   cout<<"\nNo location to attack from the blackuut at ("<<posx<<","<<posy<<")\n";
}
void blackuut::move(){
if(noofmovepos)
    {
    int usrx;
    int usry;
    cout<<"\nenter positions to move from the blackuut at ("<<posx<<","<<posy<<")\n";
    while(2){
                cin>>usrx;
                cin>>usry;
...
void blackuut::attack(){
    if(noofattackpos)
        {
            int usrx;
            int usry;
            cout<<"\nenter positions to attack from blackuut at ("<<posx<<","<<posy<<")\n";
    while(2){
                cin>>usrx;
                cin>>usry;
