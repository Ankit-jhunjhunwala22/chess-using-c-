...
int whiteelephant::givemetheplayer()
{
return 203;
}
void whiteelephant::findpossiblelocationtomoveorattack()
{
int i,j;
i=j=0;
int curx;
...
if(noofmovepos)
    {
        ...
        int j=0;
        int tem;
        cout<<"possible location to move from the white elephant at("<<posx<<","<<posy<<")\n";
    ...
    cout<<"No location to move from the whiteelephant at ("<<posx<<","<<posy<<")\n";
if(noofattackpos)
    {
   ...
   cout<<"\nNo location to attack from the whiteelephant at ("<<posx<<","<<posy<<")\n";
}

void whiteelephant::move(){
if(noofmovepos)
    {
    int usrx;
    int usry;
    cout<<"\nenter positions to move from the whiteelephant ("<<posx<<","<<posy<<")\n";
    while(2){
                cin>>usrx;
                cin>>usry;
...
void whiteelephant::attack(){
    if(noofattackpos)
        {
            int usrx;
            int usry;
            cout<<"\nenter positions to attack from whiteelephant at("<<posx<<","<<posy<<")\n";
    while(2){
                cin>>usrx;
                cin>>usry;
