...
int whitehorse::givemetheplayer(){
    return 205;
}
void whitehorse::findpossiblelocationtomoveorattack()
{
    int i,j;
    i=0;
    j=0;
    ...
    else if((posx-2>=0 && posy+1<=7) && chessboard[posx-2][posy+1]->givetypeofplayer()==0)
    {
    ...
    else if((posx-2>=0 && posy-1>=0) && chessboard[posx-2][posy-1]->givetypeofplayer()==0)
    {
        northcountertoattack++;
        possibleattack[j].x=posx-2;
        possibleattack[j++].y=posy-1;
    ...
    else if((posx-1>=0 && posy+2<=7) && chessboard[posx-1][posy+2]->givetypeofplayer()==0)
    {
        eastcountertoattack++;
    ...
    else if((posx+1<=7 && posy+2<=7) && chessboard[posx+1][posy+2]->givetypeofplayer()==0)
    {
        eastcountertoattack++;
        possibleattack[j].x=posx+1;
        possibleattack[j++].y=posy+2;
...
southcountertomove=0;
    ...
    else if((posx+2<=7 && posy-1>=0) && chessboard[posx+2][posy-1]->givetypeofplayer()==0)
    {
    ...
    else if((posx+2<=7 && posy+1<=7) && chessboard[posx+2][posy+1]->givetypeofplayer()==0)
    {
        southcountertoattack++;
        possibleattack[j].x=posx+2;
        possibleattack[j++].y=posy+1;
...
if((posx-1>=0 && posy-2>=0) && chessboard[posx-1][posy-2]==NULL)
    ...
    else if((posx-1>=0 && posy-2>=0) && chessboard[posx-1][posy-2]->givetypeofplayer()==0)
    {
        westcountertoattack++;
        possibleattack[j].x=posx-1;
        possibleattack[j++].y=posy-2;
...
if((posx+1<=7 && posy-2>=0) && chessboard[posx+1][posy-2]==NULL)
    ...
    else if((posx+1<=7 && posy-2>=0) && chessboard[posx+1][posy-2]->givetypeofplayer()==0)
    {
        westcountertoattack++;
        possibleattack[j].x=posx+1;
        possibleattack[j++].y=posy-2;
...
if(noofmovepos)
{
    cout<<"\npossible to move from the whitehorse from position at ("<<posx<<","<<posy<<")\n";
    int tem;
    int i;
    i=0;
    ...
    cout<<"\nNo possible to move from the whitehorse from position at ("<<posx<<","<<posy<<")\n";

if(noofattackpos)
{
    cout<<"\npossible location to attack from whitehorse at ("<<posx<<","<<posy<<")\n";
    int i;
    i=0;
...
cout<<"\nNo possible location to attack from whitehorse at ("<<posx<<","<<posy<<")\n";

}
void whitehorse::move(){
if(noofmovepos)
    {
    int usrx;
    int usry;
    cout<<"\nenter positions to move from the whitehorse at ("<<posx<<","<<posy<<")\n";
    while(2){
                cin>>usrx;
                cin>>usry;
...
void whitehorse::attack(){
    if(noofattackpos)
        {
            int usrx;
            int usry;
            cout<<"\nenter positions to attack from whitehorse at ("<<posx<<","<<posy<<")\n";
    while(2){
                cin>>usrx;
                cin>>usry;
